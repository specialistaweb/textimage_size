...
:Email:
    at@specialistaweb.it, gt@pecialistaweb.it
...
allows you to change the output  layout for text/image (also said: textpict) content under boostrap 4 so you can get different size for text or image cols and not only the 50%-50% split
...
**Community Documentation:**
    ...
    This documentation is community documentation for the TYPO3 extension Text/Image size
